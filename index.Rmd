...
First of all, we have to load a tree. Use the dialogue below to choose a file that contains a tree in Newick format, then press 'Submit'.
...
```{r, echo=FALSE}
actionButton("drawtree","Plot tree")
renderPlot({
  if(input$drawtree==0) return()
  ggtree(tr())
})
```
